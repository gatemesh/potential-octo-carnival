...
// #define GATEMESH_MINIMIZE_BUILD 1
#ifdef GATEMESH_MINIMIZE_BUILD
#define GATEMESH_EXCLUDE_MODULES 1
#define GATEMESH_EXCLUDE_WIFI 1
#define GATEMESH_EXCLUDE_BLUETOOTH 1
#define GATEMESH_EXCLUDE_GPS 1
#define GATEMESH_EXCLUDE_SCREEN 1
#define GATEMESH_EXCLUDE_MQTT 1
#define GATEMESH_EXCLUDE_POWERMON 1
#define GATEMESH_EXCLUDE_I2C 1
#define GATEMESH_EXCLUDE_PKI 1
#define GATEMESH_EXCLUDE_POWER_FSM 1
#define GATEMESH_EXCLUDE_TZ 1
#endif

// Turn off all optional modules
#ifdef GATEMESH_EXCLUDE_MODULES
#define GATEMESH_EXCLUDE_AUDIO 1
#define GATEMESH_EXCLUDE_DETECTIONSENSOR 1
#define GATEMESH_EXCLUDE_ENVIRONMENTAL_SENSOR 1
#define GATEMESH_EXCLUDE_HEALTH_TELEMETRY 1
#define GATEMESH_EXCLUDE_EXTERNALNOTIFICATION 1
#define GATEMESH_EXCLUDE_PAXCOUNTER 1
#define GATEMESH_EXCLUDE_POWER_TELEMETRY 1
#define GATEMESH_EXCLUDE_RANGETEST 1
#define GATEMESH_EXCLUDE_REMOTEHARDWARE 1
#define GATEMESH_EXCLUDE_STOREFORWARD 1
#define GATEMESH_EXCLUDE_TEXTMESSAGE 1
#define GATEMESH_EXCLUDE_ATAK 1
#define GATEMESH_EXCLUDE_CANNEDMESSAGES 1
#define GATEMESH_EXCLUDE_NEIGHBORINFO 1
#define GATEMESH_EXCLUDE_TRACEROUTE 1
#define GATEMESH_EXCLUDE_WAYPOINT 1
#define GATEMESH_EXCLUDE_INPUTBROKER 1
#define GATEMESH_EXCLUDE_SERIAL 1
#define GATEMESH_EXCLUDE_POWERSTRESS 1
#define GATEMESH_EXCLUDE_ADMIN 1
#endif

// // Turn off wifi even if HW supports wifi (webserver relies on wifi and is also disabled)
#ifdef GATEMESH_EXCLUDE_WIFI
#define GATEMESH_EXCLUDE_WEBSERVER 1
#undef HAS_WIFI
#define HAS_WIFI 0
#endif
...
// // Turn off Bluetooth
#ifdef GATEMESH_EXCLUDE_BLUETOOTH
#undef HAS_BLUETOOTH
#define HAS_BLUETOOTH 0
#endif

// // Turn off GPS
#ifdef GATEMESH_EXCLUDE_GPS
#undef HAS_GPS
#define HAS_GPS 0
#undef GATEMESH_EXCLUDE_RANGETEST
#define GATEMESH_EXCLUDE_RANGETEST 1
#endif

// Turn off Screen
#ifdef GATEMESH_EXCLUDE_SCREEN
#undef HAS_SCREEN
#define HAS_SCREEN 0
#endif
