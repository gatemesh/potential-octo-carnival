...
int generate_self_signed_x509(EVP_PKEY *pkey, X509 **x509)
{
    *x509 = X509_new();
    ...
    X509_NAME_add_entry_by_txt(name, "O", MBSTRING_ASC, (unsigned char *)"GateMesh", -1, -1, 0);
    X509_NAME_add_entry_by_txt(name, "CN", MBSTRING_ASC, (unsigned char *)"gatemesh.local", -1, -1, 0);
